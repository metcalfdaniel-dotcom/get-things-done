---
name: gtd-research-phase
description: Research how to implement a phase (standalone - usually use /gtd-plan-phase instead)
argument-hint: "[phase]"
allowed-tools:
  - Read
  - Bash
...
**Note:** This is a standalone research command. For most workflows, use `/gtd-plan-phase` which integrates research automatically.
...
<downstream_consumer>
Your RESEARCH.md will be loaded by `/gtd-plan-phase` which uses specific sections:
