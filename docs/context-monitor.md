...
| CRITICAL | <= 25% | Stop immediately, save state (`/gtd-pause-work`) |
...
GTD's `/gtd-pause-work` command saves execution state. The WARNING message suggests using it. The CRITICAL message instructs immediate state save.
