# Referência de Agentes do GTD

Este documento descreve os papéis dos agentes especializados no ecossistema GTD.  
...
O GTD usa um **orquestrador leve** para coordenar subagentes especializados por etapa:
