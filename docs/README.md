...
Comprehensive documentation for the Get Things Done (GTD) framework — a meta-prompting, context engineering, and spec-driven development system for AI coding agents.
...
| [CLI Tools Reference](CLI-TOOLS.md) | Contributors, agent authors | `gtd-tools.cjs` programmatic API for workflows and agents |
...
- **Getting started:** [README](../README.md) → install → `/gtd-new-project`
- **Full workflow walkthrough:** [User Guide](USER-GUIDE.md)
- **All commands at a glance:** [Command Reference](COMMANDS.md)
- **Configuring GTD:** [Configuration Reference](CONFIGURATION.md)
