...
Get Things Done（GTD）フレームワークの包括的なドキュメントです。GTD は、AI コーディングエージェント向けのメタプロンプティング、コンテキストエンジニアリング、仕様駆動開発システムです。
...
| [CLI ツールリファレンス](CLI-TOOLS.md) | コントリビューター、エージェント作成者 | `gtd-tools.cjs` のプログラマティック API（ワークフローおよびエージェント向け） |
...
- **はじめに:** [README](../README.md) → インストール → `/gtd-new-project`
- **ワークフロー完全ガイド:** [ユーザーガイド](USER-GUIDE.md)
- **コマンド一覧:** [コマンドリファレンス](COMMANDS.md)
- **GTD の設定:** [設定リファレンス](CONFIGURATION.md)
