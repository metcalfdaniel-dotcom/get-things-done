...
function cmdInitExecutePhase(cwd, phase, raw) {
  ...
  const result = {
    // Models
    executor_model: resolveModelInternal(cwd, 'gtd-executor'),
 ...
 * @param {string} agentType - The agent type (e.g., 'gtd-executor', 'gtd-planner')
 ...
 * Used by workflows: SKILLS=$(node "$TOOLS" agent-skills gtd-executor 2>/dev/null)
 */
