...
```bash
node "$HOME/.claude/get-things-done/bin/gtd-tools.cjs" commit "chore: archive phase directories from completed milestones" --files .planning/milestones/ .planning/phases/
```
