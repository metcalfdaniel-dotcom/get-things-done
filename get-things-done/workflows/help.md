...
**GTD** (Get Things Done) creates hierarchical project plans optimized for solo agentic development with Claude Code.
...
3. `/gtd-execute-phase 1` - Execute the phase
...
```
/gtd-new-project → /gtd-plan-phase → /gtd-execute-phase → repeat
```
...
Usage: `/gtd-research-phase 3`

**`/gtd-list-phase-assumptions <number>`**
...
Usage: `/gtd-list-phase-assumptions 3`

**`/gtd-plan-phase <number>`**
...
Usage: `/gtd-execute-phase 5`
Usage: `/gtd-execute-phase 5 --wave 2`
...
Usage: `/gtd-do fix the login button`
Usage: `/gtd-do refactor the auth system`
Usage: `/gtd-do I want to start a new milestone`

### Quick Mode

**`/gtd-quick [--full] [--discuss] [--research]`**
...
Usage: `/gtd-add-phase "Add admin dashboard"`

**`/gtd-insert-phase <after> <description>`**
...
Usage: `/gtd-insert-phase 7 "Fix critical auth bug"`
Result: Creates Phase 7.1

**`/gtd-remove-phase <number>`**
...
Usage: `/gtd-note refactor the hook system`
Usage: `/gtd-note list`
Usage: `/gtd-note promote 3`
Usage: `/gtd-note --global cross-project idea`

### Todo Management

**`/gtd-add-todo [description]`**
...
Usage: `/gtd-add-todo` (infers from conversation)
Usage: `/gtd-add-todo Add auth token refresh`

**`/gtd-check-todos [area]`**
List pending todos and select one to work on.

- Lists all pending todos with title, area, age
- Optional area filter (e.g., `/gtd-check-todos api`)
- Loads full context for selected todo
- Routes to appropriate action (work now, add to phase, brainstorm)
- Moves todo to done/ when work begins

Usage: `/gtd-check-todos`
Usage: `/gtd-check-todos api`
...
Usage: `/gtd-ship 4` or `/gtd-ship 4 --draft`

---

**`/gtd-review --phase N [--gemini] [--claude] [--codex] [--all]`**
...
Usage: `/gtd-plant-seed "add real-time notifications when we build the events system"`
...
- Ready for `/gtd-plan-phase` on new phases

Usage: `/gtd-plan-milestone-gaps`
...
**`/gtd-set-profile <profile>`**
Quick switch model profile for GTD agents.
...
- Better than raw `npx get-things-done-cc`

Usage: `/gtd-update`

**`/gtd-join-discord`**
Join the GTD Discord community.

- Get help, share what you're building, stay updated
- Connect with other GTD users

Usage: `/gtd-join-discord`
...
/clear
/gtd-execute-phase 1    # Execute all plans in phase
```
...
```
/gtd-insert-phase 5 "Critical security fix"
/gtd-plan-phase 5.1
/gtd-execute-phase 5.1
```
...
```
/gtd-add-todo                    # Capture from conversation context
/gtd-add-todo Fix modal z-index  # Capture with explicit description
/gtd-check-todos                 # Review and work on todos
/gtd-check-todos api             # Filter by area
```
