...
This seed should be presented during `/gtd-new-milestone` when the milestone
...
```bash
node "$HOME/.claude/get-things-done/bin/gtd-tools.cjs" commit "docs: plant seed — {$IDEA}" --files .planning/seeds/SEED-{PADDED}-{slug}.md
```
</step>
