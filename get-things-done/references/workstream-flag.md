...
```bash
# All gtd-tools commands accept --ws
node gtd-tools.cjs state json --ws feature-a
node gtd-tools.cjs find-phase 3 --ws feature-b

# Workstream CRUD
node gtd-tools.cjs workstream create <name>
node gtd-tools.cjs workstream list
node gtd-tools.cjs workstream status <name>
node gtd-tools.cjs workstream complete <name>
```
