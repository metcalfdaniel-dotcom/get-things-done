...
/**
 * Extract the tools list from a gtd-executor.md agent definition.
...
/**
 * Extract the role instructions from a gtd-executor.md agent definition.
 ...
 * @param agentDef - Raw content of gtd-executor.md agent definition (optional)
