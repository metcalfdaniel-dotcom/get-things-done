...
| `gtd-executor` | References as visual source of truth during implementation |
...
```bash
node "$HOME/.claude/get-things-done/bin/gtd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
